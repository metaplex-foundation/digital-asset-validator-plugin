...
use crate::{common_generated::*, compiled_instruction_generated::*};
...
impl Default for TransactionInfoArgs<'_> {
    #[inline]
    fn default() -> Self {
        TransactionInfoArgs {
            is_vote: false,
...
impl Default for InnerInstructionsArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for CompiledInnerInstructionsArgs<'_> {
    #[inline]
    fn default() -> Self {
...
#[inline]
pub fn finish_transaction_info_buffer<'a>(
...
#[inline]
pub fn finish_size_prefixed_transaction_info_buffer<'a>(
    fbb: &mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<TransactionInfo<'a>>,
) {
