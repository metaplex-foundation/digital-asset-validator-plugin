...
impl Default for CompiledInstructionArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> CompiledInnerInstruction<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.compiled_instruction {
            builder.add_compiled_instruction(x);
        }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<CompiledInstruction>>(
                    CompiledInnerInstruction::VT_COMPILED_INSTRUCTION,
                    None,
                )
        }
    }
    ...
    pub fn stack_height(&self) -> u8 {
        ...
        unsafe {
            self._tab
                .get::<u8>(CompiledInnerInstruction::VT_STACK_HEIGHT, Some(0))
                .unwrap()
        }
    }
}
...
impl Default for CompiledInnerInstructionArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a: 'b, 'b> CompiledInnerInstructionBuilder<'a, 'b> {
    #[inline]
    pub fn add_compiled_instruction(
        &mut self,
        compiled_instruction: flatbuffers::WIPOffset<CompiledInstruction<'b>>,
    ) {
        self.fbb_
    ...
    pub fn add_stack_height(&mut self, stack_height: u8) {
        self.fbb_
            .push_slot::<u8>(CompiledInnerInstruction::VT_STACK_HEIGHT, stack_height, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    ) -> CompiledInnerInstructionBuilder<'a, 'b> {
        let start = _fbb.start_table();
...
#[inline]
pub fn finish_compiled_instruction_buffer<'a>(
...
#[inline]
pub fn finish_size_prefixed_compiled_instruction_buffer<'a>(
    fbb: &mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<CompiledInstruction<'a>>,
) {
