    ...
    fn on_load(&mut self, config_file: &str) -> Result<()> {
        ...
        runtime.spawn(async move {
            ...
            for _ in 0..workers_num {
                ...
                msg.set_buffer_size(ACCOUNT_STREAM, config.account_stream_size.unwrap_or(250_000_000)).await;
                msg.set_buffer_size(SLOT_STREAM, config.slot_stream_size.unwrap_or(200_000)).await;
                msg.set_buffer_size(TRANSACTION_STREAM, config.transaction_stream_size.unwrap_or(20_000_000)).await;
                msg.set_buffer_size(BLOCK_STREAM, config.block_stream_size.unwrap_or(200_000)).await;
